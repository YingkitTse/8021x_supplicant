...
/* 打印服务器回显信息 */
#define WITH_ICONV 0
/* 自定义服务器MAC,在路由器中802.1x规定的多播地址发送不到认证服务器 */
#define CONFIG_SERVER_MAC 1
...
uint8_t      muticast_mac[] =
#if CONFIG_SERVER_MAC /* 自定义服务器MAC地址 */
						{0x00, 0x03, 0x0f, 0x14, 0x99, 0xf9};/* 服务器MAC地址，各不相同，抓取正常认证的包分析下，推荐wireshark */
#else
						{0x01, 0x80, 0xc2, 0x00, 0x00, 0x03};/* 802.1x的认证服务器多播地址 */
#endif
